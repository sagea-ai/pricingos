...
export function ProfileForm({ user }: ProfileFormProps) {
  ...
  return (
    <div className="space-y-10 p-0">
      {/* Profile Information */}
      <div className="border-b border-gray-100 dark:border-gray-800 px-8 pt-8 pb-10 bg-gradient-to-r from-amber-50 to-white dark:from-amber-950/10 dark:to-gray-950 rounded-t-lg">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <Avatar className="h-24 w-24 shadow-lg border-4 border-amber-100 dark:border-amber-900">
          ...
          <div className="flex-1 space-y-2">
            ...
            <Badge variant="secondary" className="mt-2 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-200 border-none">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="shrink-0 border-amber-200 dark:border-amber-700"
              >
