...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    ...
    elevated:
      "rounded-2xl border bg-card text-card-foreground shadow-lg shadow-black/5 dark:shadow-black/20",
    minimal: "rounded-xl bg-card text-card-foreground border-0 shadow-none",
    glass:
