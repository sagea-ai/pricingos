        ...
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-amber-200 dark:border-amber-800">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{user.referrals.length}</div>
            ...
            <Card className="border-amber-200 dark:border-amber-800">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">${totalCredits.toFixed(2)}</div>
                <p className="text-xs text-muted-foreground">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card className="bg-amber-300/20 dark:amber-900/20 border-amber-200 dark:border-amber-800">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  <Input
                    value={referralUrl}
                    readOnly
                    className="font-mono text-sm bg-white dark:bg-gray-800 border-amber-200 dark:border-amber-700"
                  />
                  <Button 
                    onClick={copyToClipboard}
                    variant="outline" 
                    size="sm"
                    className="shrink-0 border-amber-200 dark:border-amber-700 hover:bg-amber-50 dark:hover:bg-amber-900/20"
                  >
                    {copied ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
                
                <Button onClick={shareReferral} className="w-full bg-amber-600 hover:bg-amber-700">
                  <Share2 className="h-4 w-4 mr-2" />
                  Share Referral Link
                </Button>
                
                <div className="rounded-lg bg-white/50 dark:bg-gray-800/50 p-4 text-sm border border-amber-200 dark:border-amber-700">
                  <h4 className="font-medium mb-2 text-amber-700 dark:text-amber-300">How it works:</h4>
              ...
              <CardContent>
                {referralCredits.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <DollarSign className="h-8 w-8 mx-auto mb-2 text-amber-300 dark:text-amber-600" />
            ...
            <CardContent>
              {user.referrals.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <Users className="h-12 w-12 mx-auto mb-4 text-amber-300 dark:text-amber-600" />
                  <h3 className="text-lg font-medium mb-2">No referrals yet</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Share your referral link to start earning credits
                  </p>
                  <Button onClick={shareReferral} variant="outline" className="border-amber-200 dark:border-amber-700 hover:bg-amber-50 dark:hover:bg-amber-900/20">
                    <Share2 className="h-4 w-4 mr-2" />
                    Share Your Link
                  </Button>
                </div>
