        ...
        <div className="max-w-5xl mx-auto py-6 px-2 sm:px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow duration-200 p-2">
              <CardHeader className="pb-1">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline" className="ml-2 border-gray-200 dark:border-gray-700 text-xs text-amber-700 dark:text-amber-300 bg-white dark:bg-gray-950">
                    Most Popular
                  </Badge>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <Button className="w-full bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2 rounded-lg transition-all duration-150 text-sm">
                  Upgrade to Pro
            ...
            <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow duration-200 p-2">
              ...
              <CardContent>
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-gray-200 dark:border-gray-700 text-amber-700 dark:text-amber-300 font-semibold py-2 rounded-lg transition-all duration-150 text-sm"
                  asChild
                >
          ...
          <div className="text-center mt-4">
            <span className="text-xs text-gray-500 dark:text-gray-400">
              ...
              <a href="mailto:support@sagea.space" className="text-amber-600 hover:underline">
                Contact us
              </a>
            </span>
          </div>
